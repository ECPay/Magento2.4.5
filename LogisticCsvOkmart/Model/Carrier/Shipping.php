<?php
namespace Ecpay\LogisticCsvOkmart\Model\Carrier;
...
class Shipping extends AbstractCarrier implements CarrierInterface
{
     ...
     * @var string
     */
    protected $_code = 'ecpaylogisticcsvokmart';
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        if ($total > $maxOrderAmount) {
            ...
            $this->_loggerInterface->debug('LogisticCsvOkmart collectRates 超過購物車最高金額門檻');
            return false;
        }
        ...
        if ($minOrderAmount != 0 && $total < $minOrderAmount) {
            ...
            $this->_loggerInterface->debug('LogisticCsvOkmart collectRates 低於購物車最低金額門檻');
            return false;
        }
        ...
        if ($freeShippingEnable == 1 && $total >= $freeShippingSubtotal) {
            ...
            $this->_loggerInterface->debug('LogisticCsvOkmart collectRates 到達免運門檻');
            $amount = 0 ;
        }
