<?php
namespace Ecpay\LogisticHomePost\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
     ...
     * @var string
     */
    protected $_code = 'ecpaylogistichomepost';
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        // 計算重量運費
        $amount = $this->_logisticService->calculateHomePostShippingWeight(
            $shippingWeight,
            $this->getConfigData('shipping_fee_1') ?: 0,
            $this->getConfigData('shipping_fee_2') ?: 0,
